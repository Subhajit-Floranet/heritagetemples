...
<form action="{{url('/AddTempleImage')}}" method="post">
    @csrf
<div class="container">
    ...
    <option value="{{$datas['id']}}">{{$datas['temple_name']}}</option>
    @endforeach
    @else
    ...
    <p><b>Select The Banner Image</b></p>
    <input type="file" class="form-control" placeholder="" name="banner_image[]" id="banner_image">
    </div> 
    </td>
    <td>
    <div class="form-floating">
...
<script>
    ...
    <p><b>Select The Banner Image</b></p>\
    <input type="file" class="form-control" placeholder="" name="banner_image[]" id="banner_image"></div></td><td>\
